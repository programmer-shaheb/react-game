  ...
  })()(
    {
          ...
          function adapterFactory() {
            ...
            switch (browserDetails.browser) {
              case "chrome":
                ...
                commonShim.shimRTCIceCandidateRelayProtocol(
                  window,
                  browserDetails
                );
      ...
      6: [
        function (require, module, exports) {
          ...
          exports.shimRTCIceCandidateRelayProtocol =
            ...
            if (origAddTransceiver) {
              window.RTCPeerConnection.prototype.addTransceiver =
                function addTransceiver() {
                  ...
                  var sendEncodings =
                    arguments[1] && arguments[1].sendEncodings;
      ...
      12: [
        function (require, module, exports) {
          ...
          SDPUtils.parseRtpParameters = function (mediaSection) {
            ...
            var wildcardRtcpFb = SDPUtils.matchPrefix(
              mediaSection,
              "a=rtcp-fb:* "
            ).map(SDPUtils.parseRtcpFb);
            description.codecs.forEach(function (codec) {
              wildcardRtcpFb.forEach(function (fb) {
                var duplicate = codec.rtcpFeedback.find(function (
                  existingFeedback
                ) {
                  return (
